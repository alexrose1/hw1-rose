...
-- TODO!
SELECT movies.title, movies.year_produced, movies.rating, studios.studio_name
...
SELECT movies.title, actors.first_name, actors.last_name, actors.character_name
